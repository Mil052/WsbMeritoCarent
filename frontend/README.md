...
Projekt podzielić można na 3 części związane z rolą użytkowników:
...
1. Sklonuj repozytorium
	...
	```
2. Przejdź do katalogu _frontend_
	```sh
	cd frontend
	```
3. Zainstaluj _dependencies_
	...
	npm install
	```
4. Utwórz plik `.env` w katalogu _frontend_  
	Wszystkie zmienne środowiskowe, które powinny znaleźć się w środku tego pliku dostępne są w pliku `.env.temp`
